...
const _schema = i.schema({
  entities: {
    galleries: i.entity({
      ...
      watermarkEnabled: i.boolean().optional(),
      watermarkType: i.string().optional(),
      watermarkText: i.string().optional(),
      watermarkImageUrl: i.string().optional(),
      watermarkPosition: i.string().optional(),
      watermarkOpacity: i.number().optional(),
